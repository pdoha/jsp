...
<body>
<h2>application영역</h2>
서버에 생성과 소멸까지 서버에 접근하는 모든 사람들이 공유할 수 있는영역
<!--
	웹서버가 실행시 생성되는 영역
